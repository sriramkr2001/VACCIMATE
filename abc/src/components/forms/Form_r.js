            ...
            <TwoColumn>
              <Column>
                ...
                <InputContainer style={{display:"flex",flexDirection:"row"}}>
                  <Label htmlFor="status-input">Urgency of the Request -(Will be appropriately Verified)</Label>
                
                  <select name="urgency_status" id="cars" style={{backgroundColor:"rgba(100,21,255)",marginTop:"0.5rem"}} required="true" value={state.urgency_status} 
...
<option value="Slight Urgency">Slight Urgency</option>
...
<option value="Critical">Critical</option>
                ...
                <InputContainer>
                  ...
                  <Input id="phoneNo-input" type="phoneNo" name="phone_no" placeholder="ex:9901666922" required="true" value={state.phone_no}
                  onChange={(e)=>{
                    let x=e.target.name
                       setState({...state, [x]:e.target.value})
                  }}
...
<option value="Plasma">Plasma</option>
  ...
  <option value="grocery">Grocery</option>
                 ...
                 {location.pathname==="/explore/oxygen/emergency_drugs"&&
                  <InputContainer style={{display:"flex",flexDirection:"row"}}>
  ...
  <option value="Isuvaconazole" selected>others</option>
                  ...
                  {location.pathname==="/explore/oxygen/hospital_beds"&&
                  <InputContainer style={{display:"flex",flexDirection:"row"}}>
