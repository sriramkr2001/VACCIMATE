...
import { ReactComponent as MoneyIcon } from "images/dot-pattern.svg";
...
export default ({
  ...
  description = "We are a value driven organization and our primary mission is to ensure that all our users are provided access to genuine , verified leads the processing of which might include a buffer time of 1-2 days at max. till then choose amongst the given leads with care and carefulness. we pray for the well-being off all during these tough times of the pandemic Stay home, Stay safe !",
